...
--POSE_GRAPH.constraint_builder.sampling_ratio = 2e5 --Increase use more nodes in finding the loop closure
...
--POSE_GRAPH.constraint_builder.sampling_ratio = 0.5 --Increase to evaluate more loop closure candidates
